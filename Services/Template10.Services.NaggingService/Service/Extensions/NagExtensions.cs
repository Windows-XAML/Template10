...
namespace Template10.Extensions
{
    ...
    {
        internal static Template10.Services.FileService.StorageStrategies ToFileServiceStrategy(this Template10.Services.NagService.Nag.StorageStrategies strategy)
        {
            switch (strategy)
            {
