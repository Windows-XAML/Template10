...
namespace Template10.Services.Nag
{
    ...
    {
        /// <summary>
        /// The unique id of the associated <see cref="NagObject"/>
        /// </summary>
        ...
        /// <summary>
        /// The number of times the app has been launched and the <see cref="NagObject"/> registered
        /// </summary>
        public int LaunchCount { get; set; }

        /// <summary>
        /// Timestamp of when the <see cref="NagObject"/> was first registered
        /// </summary>
        ...
        /// <summary>
        /// Determines if the <see cref="NagObject"/> should be shown
        /// </summary>
        ...
        /// Determines if the <see cref="NagObject"/> should be shown
        /// </summary>
        /// <param name="duration">The amount of time to wait after the first registartion before showing the <see cref="NagObject"/></param>
