...
namespace Template10.Services.Nag
{
    ...
    /// </summary>
    public class NagObject
    {
        /// <summary>
        /// ctor
        /// </summary>
        /// <param name="id"><see cref="NagObject.Id"/></param>
        /// <param name="message"><see cref="NagObject.Message"/></param>
        /// <param name="nagAction"><see cref="NagObject.NagAction"/></param>
        public NagObject(string id, string message, Action nagAction)
        {
