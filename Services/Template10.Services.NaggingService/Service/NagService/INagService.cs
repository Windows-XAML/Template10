...
namespace Template10.Services.Nag
{
    ...
    public interface INagService
    {
        ...
        /// </summary>
        /// <param name="nag">The <see cref="NagObject"/></param>
        ...
        Task Register(NagObject nag, int launches, TimeSpan duration);
        ...
        /// <param name="launches">The number of app launches to pass before showing the nag</param>
        /// <returns><see cref="Task"/></returns>
        Task Register(NagObject nag, int launches);
        ...
        /// <param name="duration">The amount of time to pass from the first launch before showing the nag</param>
        /// <returns><see cref="Task"/></returns>
        Task Register(NagObject nag, TimeSpan duration);

        /// <summary>
        /// Determines if the given nag has been registered
        /// </summary>
        /// <param name="nagId">The if of the <see cref="NagObject"/></param>
        ...
        /// </summary>
        /// <param name="nagId">The if of the <see cref="NagObject"/> to find</param>
        ...
        /// </summary>
        /// <param name="nagId">The id of the <see cref="NagObject"/> to delete</param>
        /// <returns><see cref="Task"/></returns>
