...
namespace Template10.Common
{
    ...
    public abstract class BootStrapper : Application, INotifyPropertyChanged, IBootStrapper
    {
        ...
        /// </summary>
        public IDictionary<string, object> SessionState { get; } = Template10.Portable.SessionState.Current;
        ...
        public async virtual Task<UIElement> CreateRootElementAsync(IActivatedEventArgs e)
        {
            ...
            var navigationService = await NavigationServiceFactoryAsync(BackButton.Attach, ExistingContent.Include, navigationFrame);
        ...
        /// </summary>
        public async Task<INavigationService> NavigationServiceFactoryAsync(BackButton backButton, ExistingContent existingContent, Frame frame = null)
        {
            ...
            var state = await navigationService.GetFrameStateAsync();
            var setting = await state.TryGetValueAsync<DateTime>(CacheDateKey);
            var date = setting.Success ? setting.Value : DateTime.MinValue;
