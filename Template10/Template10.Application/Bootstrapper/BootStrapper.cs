...
namespace Template10.Common
{
    public abstract partial class BootStrapper : Application, INotifyPropertyChanged, IBootStrapper
    {
        ...
        /// </summary>
        public abstract Task OnStartAsync(Template10.Template10StartArgs e);
        ...
        private async void StartupOrchestratorAsync(Template10.Template10StartArgs e)
        {
        ...
        private async Task DoStartAsActivate(Template10.Template10StartArgs e)
        {
        ...
        private async Task DoStartAsPrelaunch(Template10.Template10StartArgs e)
        {
        ...
        private async Task DoStartAsNormal(Template10.Template10StartArgs e)
        {
        ...
        private void ShowSplash(Template10.Template10StartArgs e)
        {
        ...
        private async Task DoSetupExtendedSessionAsync(Template10.Template10StartArgs e)
        {
            await Settings.ExtendedSessionStrategy.StartupAsync(e);
        }

        private async Task<UIElement> DoCreateRootElementAsync(Template10.Template10StartArgs e)
        {
        ...
        private void DoSetupTitleBar(Template10.Template10StartArgs e)
        {
            Settings.TitleBarStrategy.Startup();
        }

        private void DoSetupBackButton(Template10.Template10StartArgs e)
        {
        ...
        private void DoSetupResuming(Template10.Template10StartArgs args)
        {
            base.Resuming += (s, e) =>
            {
        ...
        private void DoSetupSuspending(Template10.Template10StartArgs args)
        {
        ...
        private async Task<bool> DoRestoreWhenResumingAsync(Template10.Template10StartArgs e)
        {
            var restored = false;
    ...
    public abstract partial class BootStrapper : Application, INotifyPropertyChanged, IBootStrapper
    {
        ...
        protected override sealed void OnActivated(IActivatedEventArgs e) { DebugWrite(); StartupOrchestratorAsync(new Template10.Template10StartArgs(e, Template10.Template10StartArgs.StartKinds.Activate)); }
        protected override sealed void OnCachedFileUpdaterActivated(CachedFileUpdaterActivatedEventArgs e) { DebugWrite(); StartupOrchestratorAsync(new Template10.Template10StartArgs(e, Template10.Template10StartArgs.StartKinds.Activate)); }
        protected override sealed void OnFileActivated(FileActivatedEventArgs e) { DebugWrite(); StartupOrchestratorAsync(new Template10.Template10StartArgs(e, Template10.Template10StartArgs.StartKinds.Activate)); }
        protected override sealed void OnFileOpenPickerActivated(FileOpenPickerActivatedEventArgs e) { DebugWrite(); StartupOrchestratorAsync(new Template10.Template10StartArgs(e, Template10.Template10StartArgs.StartKinds.Activate)); }
        protected override sealed void OnFileSavePickerActivated(FileSavePickerActivatedEventArgs e) { DebugWrite(); StartupOrchestratorAsync(new Template10.Template10StartArgs(e, Template10.Template10StartArgs.StartKinds.Activate)); }
        protected override sealed void OnSearchActivated(SearchActivatedEventArgs e) { DebugWrite(); StartupOrchestratorAsync(new Template10.Template10StartArgs(e, Template10.Template10StartArgs.StartKinds.Activate)); }
        protected override sealed void OnShareTargetActivated(ShareTargetActivatedEventArgs e) { DebugWrite(); StartupOrchestratorAsync(new Template10.Template10StartArgs(e, Template10.Template10StartArgs.StartKinds.Activate)); }
        protected sealed override void OnLaunched(LaunchActivatedEventArgs e) { DebugWrite(); StartupOrchestratorAsync(new Template10.Template10StartArgs(e, Template10.Template10StartArgs.StartKinds.Launch)); }
        protected sealed override void OnBackgroundActivated(BackgroundActivatedEventArgs e) { DebugWrite(); StartupOrchestratorAsync(new Template10.Template10StartArgs(e, Template10.Template10StartArgs.StartKinds.Background)); }
