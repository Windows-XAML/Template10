...
namespace Template10.Strategies
{
    ...
    public interface IViewModelActionStrategy
    {
        ...
        Task<ContinueResult> NavigatingFromAsync((object ViewModel, NavigationMode NavigationMode, bool Suspending) operation, INavigationInfo from, INavigationInfo to, INavigationService nav);
