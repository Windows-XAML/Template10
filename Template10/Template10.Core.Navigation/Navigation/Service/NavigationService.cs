...
#pragma warning restore CS1998 // Async method lacks 'await' operators and will run synchronously
        ...
        static IBackButtonService2 BackButtonService => Central.DependencyService.Resolve<IBackButtonService>() as IBackButtonService2;
        static ISerializationService SerializationService => Central.DependencyService.Resolve<ISerializationService>();
        static IViewModelActionStrategy ViewModelActionStrategy => Central.DependencyService.Resolve<IViewModelActionStrategy>();
        static IViewModelResolutionStrategy ViewModelResolutionStrategy => Central.DependencyService.Resolve<IViewModelResolutionStrategy>();
        ...
        public event EventHandler<Common.HandledEventArgs> BackRequested;
        public event EventHandler<Common.HandledEventArgs> ForwardRequested;
