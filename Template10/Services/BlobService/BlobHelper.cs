...
namespace Dispatchr.Client.Services
{
    public class BlobHelper
    {
        ...
        public BlobHelper(string accountName, string accessKey, string groupName, bool useHttps = false)
        {
        ...
        {
            private BlobHelper Parent { get; set; }
            private string _groupName;
            public ContainerLogic(BlobHelper parent, string groupName)
            {
                this.Parent = parent;
        ...
        public class BlobLogic
        {
            private BlobHelper Parent { get; set; }
            private string _groupName;
            public BlobLogic(BlobHelper parent, string groupName)
            {
                this.Parent = parent;
                this._groupName = groupName;
            }
