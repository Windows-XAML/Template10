...
namespace Template10.Common
{
    ...
    public class WeakReferenceEx<TInstance, TSource, TEventArgs> where TInstance : class
    {
        public WeakReference<TInstance> Reference { get; protected set; }
        public Action<TInstance, TSource, TEventArgs> EventAction { get; set; }
        public Action<TInstance, WeakReferenceEx<TInstance, TSource, TEventArgs>> DetachAction { get; set; }
