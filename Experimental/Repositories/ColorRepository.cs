    ...
    public class ColorRepository
    {
        public async Task<IEnumerable<Models.ColorInfo>> GetColorsAsync()
        {
            ...
            var colors = typeof(Colors)
                ...
                {
                    Name = SplitCamelCase(x.Name),
                    Color = x.Color,
                    ContrastForegroundBrush = new SolidColorBrush(GetContrast(x.Color)),
                    Hue = GetHue(x.Color),
                    Brightness = GetBrightness(x.Color),
                    Saturation = GetSaturation(x.Color),
                });
            return colors;
        }
