...
namespace System
{
    ...
    {
        internal static void DebugWriteMessage(this object item, string text = null, [Runtime.CompilerServices.CallerMemberName]string caller = null, [Runtime.CompilerServices.CallerLineNumber]int line = -1, [Runtime.CompilerServices.CallerFilePath]string path = null)
        {
            Diagnostics.Debug.WriteLine($"MSG {DateTime.Now} {text} caller: {caller} line: {line} path: {path}");
        }

        internal static void DebugWriteError(this object item, string text = null, [Runtime.CompilerServices.CallerMemberName]string caller = null, [Runtime.CompilerServices.CallerLineNumber]int line = -1, [Runtime.CompilerServices.CallerFilePath]string path = null)
        {
        ...
        public static ActivationKinds GetActivationKind(this IActivatedEventArgs args)
        {
